        ...
        <div class="border-4 border-orange-500 text-black rounded-lg lg:px-16 px-8 lg:py-10 py-5">
          ...
          <div class="grid lg:grid-cols-2 gap-y-8 gap-x-20">
            ...
            <div>
              ...
              <div class="lg:text-lg text-sm font-medium">
                Roblox @8pm
              </div>
            </div>
            <div>
              <h3 class="lg:text-xl font-bold text-orange-600">FRIDAYS</h3>
              <div class="lg:text-lg text-sm font-medium">
                Variety Night @8pm
              </div>
            </div>
            ...
            <!-- Right Column -->
            <div>
              <h3 class="lg:text-xl font-bold text-orange-600">SATURDAYS</h3>
              <div class="lg:text-lg text-sm font-medium">
                Valorant @8pm
              </div>
            </div>
            <div>
              <h3 class="lg:text-xl font-bold text-orange-600">SUNDAYS</h3>
              <div class="lg:text-lg text-sm font-medium">
